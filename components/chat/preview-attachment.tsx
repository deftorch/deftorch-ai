  ...
  return (
    ...
    >
      {contentType?.startsWith("image") ? (
        ...
        <div className="flex size-full flex-col items-center justify-center p-2 text-center text-xs font-medium text-muted-foreground">
          <div className="mb-1 rounded bg-foreground/10 px-2 py-1 text-[10px] uppercase">
            {name?.split('.').pop() || 'FILE'}
          </div>
          <span className="w-full truncate text-[9px]">{name}</span>
        </div>
      )}
